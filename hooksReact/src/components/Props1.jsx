...
function Props1({ chacha,index,chnageOnclick }) {
  const  { name, job, image,friend } =chacha;
  return (
    <>
      <div className="w-48 h-62 bg-zinc-100 rounded-md  flex flex-col  overflow-hidden">
        ...
        <div className="">
          ...
          <button onClick={()=>chnageOnclick(index)}
           className="px-4 py-[2px]  ms-3 mt-2 mb-2 bg-blue-500 rounded-md text-white text-sm">{friend === true ? 'Friend':"Add friend"}
